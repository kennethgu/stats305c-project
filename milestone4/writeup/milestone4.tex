...
However, fitting a simple linear model to these  covariates suggests that the improvement in test MSE from last week is likely due to the explanatory power of these new covariates, not the spatial data.
